...
export const api = {
  ...
  corsairSyncStatus: () => req('/github/corsair/sync'),
  corsairSync: body => req('/github/corsair/sync', { method: 'POST', body: body || {} }),
  corsairAsk: question => req('/github/corsair/ask', { method: 'POST', body: { question } }),
